...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    year: "2024",
    image: "https://images.unsplash.com/photo-1556740714-a8395b3bf30f?auto=format&fit=crop&q=80&w=1600",
    description: "Integrated school fee management system with Midtrans payment gateway integration.",
    longDescription: "A comprehensive financial system designed for educational institutions to manage student tuition fees (SPP). It automates billing, payment tracking, and reporting for both monthly and annual fees.",
    problem: "Manual tuition tracking and payment verification were inefficient, leading to data discrepancies and delayed financial reporting.",
    solution: "Developed an automated billing system integrated with Midtrans Payment Gateway. Students/parents can pay via various methods (VA, E-Wallet), and the system automatically updates the payment status upon successful transaction.",
    tags: ["Fintech", "Payment Gateway", "School Management", "Automated Billing"],
    technologies: ["Midtrans API", "Snap JS", "PHP", "CodeIgniter", "MySQL", "JavaScript", "Bootstrap"],
  },
  {
    id: 5,
    title: "Tourist Boat Booking System",
    category: "Independent Project",
    year: "2025",
    // image: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&q=80&w=1600",
    image: "https://images.unsplash.com/photo-1516091877740-fde016699f2c?auto=format&fit=crop&q=80&w=1600",
    description: "Maritime tourism booking platform with automated WhatsApp notifications and payment tracking.",
    longDescription: "A specialized booking engine for boat rentals to Beras Basah island. It manages the entire customer journey from boat selection to payment and real-time status updates via WhatsApp.",
